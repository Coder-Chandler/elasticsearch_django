...
from search.models import JobboleType, ZhihuQuestionType, ZhihuAnswerType, LaGou, LianjiaType
...
class SearchSuggest(View):
    def get(self, request):
        ...
        if key_words:
            if s_type == "article":
                re_datas = index_suggest(JobboleType, key_words)
            elif s_type == "job":
            ...
            elif s_type == "lianjia_house":
                re_datas = index_suggest(LianjiaType, key_words)
...
class SearchView(View):
    def get(self, request):
        ...
        topn_search = redis_cli.zrevrangebyscore("search_keywords_set", "+inf", "-inf", start=1, num=5)
        ...
        lianjia_house_count = redis_cli.get("lianjia_house_count")
        LianJia_latitude_longitude_count = redis_cli.get("LianJia_latitude_longitude_count")
        ...
        return render(request, "result.html", {"page": page,
                                               ...
                                               "lianjia_house_count": lianjia_house_count,
                                               "LianJia_latitude_longitude_count": LianJia_latitude_longitude_count,
